...
const ProjectsPage = () => {
    ...
    let categories = ["CIT","VTE", "AGRIC", "ADT", "Science", "Evolution", "Society", "Biology", "Anatomy", "Education And Literature", "Physiology", "Marketing", "Nutrition", "Animal And Livestock", "Safety And Health"];
                        ...
                        <>
                            {   
                                blogs == null ? <Loader /> : 
                                    ...
                                    :  <NoDataMessage message="No Posts pushlished" />
                            } 
                            <LoadMoreDataBtn dataArr={blogs} fetchDataFunc={pageState == 'Projects' ? fetchLatestBlogs : fetchBlogsByCategory} />
                        ...
                        <div>
                            <h1 className="font-medium text-xl mb-8">Trending <i className="fi fi-rr-arrow-trend-up"></i></h1>
                            {
                                trendingBlogs == null ? <Loader /> :
                                    ...
                                    : <NoDataMessage message="No Trending Posts Found" />
                            }
                        </div>
