...
const BlogEditor = () => {
    ...
    const handlePublishEvent = (e) => {
        ...
        if(!title.length){
            return toast.error("Write project title to publish it");
        }
    ...
    const handleBannerImageError = (e) => {
        e.target.src = theme == "light" ? lightDefaultBanner : darkDefaultBanner;
    }
                ...
                <section>
                    <div className="mx-auto max-w-[900px] w-full">
                        ...
                        <textarea
                            ...
                            className="text-4xl bg-white font-medium placeholder:opacity-40 w-full h-20 outline-none resize-none mt-10 leading-tight"
