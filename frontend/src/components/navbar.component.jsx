...
const Navbar = () => {
    ...
    const { userAuth, userAuth: { access_token, profile_img, new_notifications_available, isAdmin }, setUserAuth } = useContext(UserContext);
        ...
        <>
            <nav className="navbar">
                ...
                <div className="flex items-center gap-3 md:gap-6 ml-auto">
                    ...
                    >
                        {!searchBoxVisible ? <i className="fi fi-rr-search md:hidden text-2xl bg-grey w-12 h-12 rounded-full flex items-center justify-center"></i> :
                        <i className="fi fi-br-cross md:hidden text-2xl bg-grey w-12 h-12 rounded-full flex items-center justify-center"></i>}
                    </button>
...

                    {
                        ...
                        <>
                            <Link className="btn-purple py-2" to="/signin">Sign In</Link>
